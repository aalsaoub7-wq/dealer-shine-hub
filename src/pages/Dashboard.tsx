      ...
      <main className="container mx-auto px-3 md:px-4 py-4 md:py-8 animate-fade-in">
        ...
        <div className="flex flex-col md:flex-row gap-2 md:gap-4 mb-4 md:mb-8">
          <div className="relative flex-1 group animate-slide-in-right">
            ...
            <Input value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="pl-8 md:pl-10 text-base h-9 md:h-10 bg-secondary border-border focus:border-primary focus:shadow-glow transition-all duration-300" placeholder="S\xF6k p\xE5 m\xE4rke eller reg. nr..." />
          </div>
